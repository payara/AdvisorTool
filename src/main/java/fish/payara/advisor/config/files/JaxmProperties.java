...
public class JaxmProperties implements Analyzer<List<AdvisorBean>> {
    public JaxmProperties() {
    }
    ...
    public List<AdvisorBean> analise(File file) {
        ...
        AdvisorBean advisorFileBean = new AdvisorBean.
                AdvisorBeanBuilder("jakarta-soap-attachments-file-found-jaxm-properties", "found.jaxm.properties").
                setFile(file).
                setLine("0").
                setType(AdvisorType.ERROR).
                setMethodDeclaration("found jaxm.properties").build();
