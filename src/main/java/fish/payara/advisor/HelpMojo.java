...
/**
 * Displays usage information for the Payara Advisor Maven Plugin.
 */
@Mojo(name = "help", requiresProject = false, threadSafe = true)
public class HelpMojo extends AbstractMojo {

    static final String USAGE = String.join(System.lineSeparator(),
            "Payara Jakarta EE Upgrade Advisor Tool",
            "",
            "Usage:",
            "  mvn fish.payara.advisor:advisor-maven-plugin:help",
            ...
            "",
            "  advise",
            "    Analyzes a Jakarta EE project and provides upgrade advisories.",
            "    Parameters:",
            "      -DadviseVersion=<version>",
            "        The target Jakarta EE version to advise for.",
            "        Supported values: 10, 11",
            "        Default: 10",
            "    Examples:",
            ...
            "",
            "  microprofile-advise",
            "    Analyzes a MicroProfile project and provides upgrade advisories.",
            "    Parameters:",
            "      -DadviseVersion=<version>",
            "        The target MicroProfile version to advise for.",
            "        Supported values: 6",
            "        Default: 6",
            "    Examples:",
