...
class AdvisorMethodDeclarationTest {

    @Test
    void createVoidVisitorFromMethodDeclaration() {
        AdvisorMethodDeclaration advisorMethodDeclaration = new AdvisorMethodDeclaration();
        VoidVisitor<List<AdvisorBean>> expectedVisitor = advisorMethodDeclaration
                .createVoidVisitor("jakarta-authorization-method-change-issue-105-info",
    ...
    void createVoidVisitorReturnNull() {
        ...
        VoidVisitor<List<AdvisorBean>> expectedVisitor = advisorMethodDeclaration
                .createVoidVisitor("jakarta-authorization-method-change-issue-105-info",
                "security.jacc.PolicyContext#getContext", "secondPattern");
    ...
    void createBeanFromParsingFileWithMethodDeclaration() throws FileNotFoundException {
        ...
        VoidVisitor<List<AdvisorBean>> expectedVisitor = advisorMethodDeclaration.createVoidVisitor(
        ...
        AdvisorBean expectedBean = advisorMethodDeclaration.parseFile(
                "jakarta-authentication-method-change-issue-87-case-2-info",
